...
import banner_static from '../assets/img/sidebar/banner_static.svg'
        ...
        <div className='w-full'>
            ...
            <div className="flex  relative justify-between items-start sm:items-center w-[90%] mx-auto pt-5">
                ...
                <div className='flex gap-2'>
                    {
                        activeTab === 'Hero' ?
                            <button className="bg-[#164E21] text-white rounded-full flex items-center py-3 px-8 gap-2 active:scale-95 transition-all" onClick={() => {
                            ...
                            :
                            <button className="bg-[#164E21] text-white rounded-full flex items-center py-3 px-8 gap-2 active:scale-95 transition-all" onClick={() => setAddBannerPopUp(!addBannerPopUp)}>
            ...
            <div className={`bg-white scale-0 transition-all duration-100 overflow-hidden ${addHeroBannerPopUp ? 'ease-in scale-100' : 'ease-out'} shadow-xl  rounded-[20px] border-2 border-[#7d9383] w-full max-w-[700px] max-h-[800px] -translate-x-[50%] -translate-y-[50%] top-[50%] left-[50%] p-4 fixed z-[200]`} >
                <div className="w-full flex justify-end items-center">
                ...
                <div className='w-full flex justify-between  py-4'>
                    ...
                    <div className='w-full'>
                        ...
                        <div
                            className="bg-gray-50 rounded-lg aspect-[5/3] max-w-[200px] w-full border border-dashed overflow-hidden cursor-pointer border-gray-500"
                            onClick={() => {
                                // setActiveInputID(pageData?.images[0]?.img_id);
                            }}
                        >
            ...
            <div className=' w-[90%] mx-auto mt-10'>
                <div className='w-max rounded-[10px] flex justify-between bg-white shadown-md'>
                    <div className={`w-fit border border-[#7d9383] border-b-0  rounded-t-[10px] cursor-pointer p-2 ${activeTab === 'Hero' ? 'bg-[#227638] text-white font-[500]' : ''} `} onClick={() => setActiveTab('Hero')}>
                        <p className='text-[14px]  poppins px-3'>Hero Section</p>
                    </div>
                    <div className={`w-fit border border-[#7d9383] border-b-0  rounded-t-[10px] cursor-pointer p-2 ${activeTab === 'Offer' ? 'bg-[#227638] text-white font-[500]' : ''} `} onClick={() => setActiveTab('Offer')}>
            ...
            <div className=" w-[90%] mx-auto">
                <div className=" rounded-[25px] rounded-tl-none overflow-hidden  border-[#7d9383] border-2 bg-white p-0">
