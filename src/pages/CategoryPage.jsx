...
import category_static from '../assets/img/sidebar/category-static.svg'
...
const CategoryPage = () => {
    ...
    return (
        <div>
            ...
            {/* view category popup */}
            <div className={`bg-white scale-0 transition-all duration-100 overflow-hidden ${viewCategory ? 'ease-in scale-100' : 'ease-out'} shadow-xl  rounded-[20px] border-2 border-[#7d9383] w-full max-w-[700px] max-h-[800px] -translate-x-[50%] -translate-y-[50%] top-[50%] left-[50%] p-4 fixed z-[100]`}>
            ...
            {/* add category popup */}
            <div className={`bg-white scale-0 transition-all duration-100 overflow-hidden ${addCategoryToggle ? 'ease-in scale-100' : 'ease-out'} shadow-xl  rounded-[20px] border-2 border-[#7d9383] w-full max-w-[700px] max-h-[800px] -translate-x-[50%] -translate-y-[50%] top-[50%] left-[50%] p-4 fixed z-[100]`}>
                <div className="w-full flex justify-end items-center">
